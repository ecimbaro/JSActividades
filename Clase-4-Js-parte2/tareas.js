...
console.log(nuevoUsuario("eduardo", "ecimba@...", 123456))
...
console.log(tieneEmail(usuarioNuevo))
...
const objeto = {color : "manzana",};

console.log(tienePropiedad(objeto, "color"))
console.log(tienePropiedad(objeto, "marca"))
